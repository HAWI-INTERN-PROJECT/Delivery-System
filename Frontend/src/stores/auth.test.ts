...
describe('Auth Store', () => {
  ...
  it('logs in user', async () => {
    const mockUser = { id: 1, name: 'John', email: 'john@example.com', username: 'john', email_verified_at: null, phone: '0912345678', role: 'customer', status: 'active', created_at: '2026-01-01', updated_at: '2026-01-01' }
